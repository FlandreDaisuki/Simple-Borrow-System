...
public class ItemDatabase {
    ...
    private ItemDatabase() {
        ...
        addItem(new Item(new ItemTag("movie", "hulk"), Permission.PUBLIC));
        addItem(new Item(new ItemTag("movie", "iron man"), Permission.PUBLIC));
        addItem(new Item(new ItemTag("movie", "ted"), Permission.PUBLIC));
    }
